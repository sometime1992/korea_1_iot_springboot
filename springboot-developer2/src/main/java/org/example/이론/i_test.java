...
public class i_test {
    ...
    // 1. 테슽 코드란?
    // : 애플리케이션이 의도한 대로 작동하는지 확인하기 우해 작성된 "코드"
    ...
    // 스프링 부트 스타터 테스트 목록
    // - JUnit 5(가장 많이 씀): 자바 프로그래밍 언어용 "단위 테스트" 프레임워크
    //   : 테스트 방식을 구분할 수 있는 애너테이션을 제공
    //   : @Test를 사용: 메서드 호출 시 새 인스턴스 생성, 독립테스트 가능(테스트 코드 작성 시간이 작다)
    // - Spring Test & Spring Boot Test: 스프링 부터용 "통합 테스트" 지원
